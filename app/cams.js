...
export const CAMS = [
  ...
  },
  {
    ...
    seasonal: true,
    type: "iframe",
    // Self-hosted HLS player; no static snapshot endpoint exists.
    src: "https://skicooper.com:8443/stake/",
  },
  {
    id: "sunlight-stake",
    verification: "untested",
    ...
    seasonal: true,
    type: "image",
    src: "https://g0.ipcamlive.com/player/snapshot.php?alias=sunlightsnowstake",
  },
  {
    id: "powderhorn-stake",
    verification: "untested",
    website: "https://powderhorn.com/",
    resort: "Powderhorn",
    cam: "Snow Stake",
    region: "Western Slope",
    elevation: "8,200'",
    ...
    seasonal: true,
    type: "image",
    // HDRelay new-style endpoint; host b16 comes from the player JSON at
    // manage.hdrelay.com/player/<playerid> — re-fetch that if b16 ever breaks.
    src: "https://b16.hdrelay.com/camera/635ff973ec60cc4e98eca6ec/snapshot",
  },
  {
    id: "granby-base",
    verification: "untested",
    ...
    seasonal: false,
    type: "image",
    src: "https://player.brownrice.com/snapshot/granby2",
  },
  {
    id: "purgatory-stake",
    verification: "untested",
    ...
    seasonal: true,
    type: "image",
    // Whole assets.mcp.ski host is down for summer (HTTP 526) — fall re-check.
    src: "https://assets.mcp.ski/purgatory/SnowStake.jpg",
  },
  {
    id: "wolfcreek-base",
